...
from AskCATie.utils import next_id
...
class Question(models.Model):
    ...
    poster = models.ForeignKey(CATieProfile)
...
class Comment(models.Model):
    ...
    poster = models.ForeignKey(CATieProfile, related_name='poster_set')
    ...
    upvoters = models.ManyToManyField(CATieProfile, related_name='upvoted_set',
                                      editable=False)
    downvoters = models.ManyToManyField(CATieProfile, related_name='downvoted_set',
                                        editable=False)
    ...
    def rate(self, profile, rating):
        ...
        with atomic():
            if profile.upvoted_set.filter(
                ...
                previous_vote = 1
                # CATieProfile.objects.get(user=profile.user,
...
class QuestionAndCurrentUser(models.Model):
    ...
    profile = models.ForeignKey(CATieProfile)
