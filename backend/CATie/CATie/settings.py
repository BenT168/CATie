"""
Django settings for CATie project.
...
WSGI_APPLICATION = 'CATie.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'cate',
        'HOST': '146.169.45.98', # this is the IP address of our VM hosted in the 'prj' domain of cloudstack
        'PORT': '5432',
    }
}
...
AUTH_PROFILE_MODULE = 'login.CATieProfile'
AUTH_LDAP_GROUP_MAP = {
    ...
    'CN=doc-students-303,' + groups_dn: ('Systems Verification',),
    'CN=doc-students-304,' + groups_dn: ('Logic-Based Learning',),
    'CN=doc-students-317,' + groups_dn: ('Graphics',),
    'CN=doc-students-318,' + groups_dn: ('Custom Computing',),
    'CN=doc-students-322,' + groups_dn: ('Communicating Computer Science in Schools',),
    'CN=doc-students-331,' + groups_dn: ('Network and Web Security',),
    'CN=doc-students-332,' + groups_dn: ('Advanced Computer Architecture',),
    'CN=doc-students-338,' + groups_dn: ('Pervasive Computing',),
    'CN=doc-students-347,' + groups_dn: ('Distributed Algorithms',),
    'CN=doc-students-395,' + groups_dn: ('Machine Learning',),
}
