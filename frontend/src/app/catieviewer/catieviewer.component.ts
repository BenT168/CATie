...
@Component({
    styleUrls: ['./catieviewer.component.scss'],
    templateUrl: './catieviewer.component.html'
})

export class CATieViewerComponent implements OnInit, OnDestroy {
    headerName: string;
    videoHidden: boolean;
    videoUrl: string;
    loadedNotes: boolean;
    ...
    constructor(private route: ActivatedRoute, private coursesService: CoursesService,
                ...
                private askCATieService: AskCATieService) {
    ...
    createQuestion() {
        let status = this.askCATieService.createQuestion(this.model.title, this.courseCode,
            this.lectureName, this.model.body).subscribe(result => {
            console.log(result);
        });
        console.log("status on catie viewer page:");
        console.log(status);
    }
    ...
    saveNotes() {
        ...
        console.log("status on catie viewer for saving notes:");
        console.log(status);
    }
}
